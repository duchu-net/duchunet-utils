...
class ReduxActions {
  ...
  //     const { index_days } = state.Events;
  //     if (!index_days.some(day => day === date)) {
  //       return dispatch(this.getEvents({ date: date }))
  //     }
  ...
  // getEvents(options) {
  //   const apiUri = 'http://kalendarz.studencki.lublin.pl/api/';
  //   const { date } = options;
  //
  ...
  //     .then(() => this.fetchUrl(`${apiUri}events.php`, fetchData))
